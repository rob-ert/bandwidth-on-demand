...
public class PhysicalResourceGroupController {
    ...
    public String create(@Valid PhysicalResourceGroup physicalResourceGroup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid PhysicalResourceGroup physicalResourceGroup, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            uiModel.addAttribute("physicalResourceGroup", physicalResourceGroup);
