insert into physical_resource_group (id, admin_group, institution_name, name, version) values (1, 'urn:collab:group:surfteams.nl:nl:surfnet:diensten:bandwidth-on-demand', 'Mock_Klantnaam', 'prg1', 0);
...
insert into virtual_resource_group (id, name, surf_connext_group_name, version) values (1, 'vrg1', 'urn:collab:group:surfteams.nl:nl:surfnet:diensten:bandwidth-on-demand', 0);
insert into virtual_resource_group (id, name, surf_connext_group_name, version) values (2, 'vrg2', 'admin2', 0);
